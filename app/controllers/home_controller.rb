    ...
    def index
        ...
        if low <- 6
          if high < 5
            ...
            @bottom_T = ['팬츠/스커트(기모)', '슬랙스(기모O)', '레깅스/치마레깅스(기모O)', '기모스타킹']
          else
        ...
        #4
          ...
          if high < 8
              ...
              @bottom_T = ['3부 바지','팬츠/스커트(린넨)','팬츠(생지)',  '살색스타킹']
        ...
        if high<18
          ...
          @top_X = ['셔츠/블라우스 (모직)','니트','맨투맨/후드','맨투맨/후드(기모)','터틀넥']
          @top_T = ['민소매','두꺼운 니트','긴팔 티셔츠']
        else
